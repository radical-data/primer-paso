create table if not exists organisation_signing_certificates (
	...
	created_by_member_id uuid references organisation_members(id) on delete set null,
...
create index if not exists organisation_signing_certificates_organisation_id_idx
	on organisation_signing_certificates (organisation_id);

create index if not exists organisation_signing_certificates_created_by_member_id_idx
	on organisation_signing_certificates (created_by_member_id);
